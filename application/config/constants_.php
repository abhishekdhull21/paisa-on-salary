...
defined('ALL_FROM_EMAIL') OR define('ALL_FROM_EMAIL', 'info@sotcrm.com');

defined('BCC_SANCTION_EMAIL') OR define('BCC_SANCTION_EMAIL', 'tech.team@sotcrm.com');
defined('BCC_DISBURSAL_EMAIL') OR define('BCC_DISBURSAL_EMAIL', '');
defined('BCC_NOC_EMAIL') OR define('BCC_NOC_EMAIL', 'tech.team@sotcrm.com');
...
define("COMPONENT_PATH", "/var/www/html/devmunitech/common_component/");
...
define("LMS_URL", "http://localhost/sot_crm/");
