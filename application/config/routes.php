...
$route['send_settlement_loan_letter'] = "CollectionController/send_settlement_letter";
...
$route['support/pincode-list'] = 'SupportController/pincodeList';
