...
defined('BCC_NOC_EMAIL') OR define('BCC_NOC_EMAIL', 'tech.team@surya.com');
...
define("TEMP_UPLOAD_PATH", "/home/devmunitechuat/public_html/temp_upload/");
define("UPLOAD_S3_PATH", "s3://bl-upload-files-dev/bl-upload-files-dev-folder/bl-upload-files-dev/");
...
define("NON_CONTACTABLE_ROTATE_COUNTER", 3);
