    ...
    function lw_send_email($to_email, $subject, $message, $bcc_email = "", $cc_email = "", $from_email = "", $reply_to = "info@surya.com", $attchement_path = "", $attachement_name = "") {
        ...
        if (empty($to_email) || empty($subject) || empty($message)) {
            ...
            if ($active_id == 1) {
                ...
                if (strstr("Loan Disbursal Letter", "Disbursal Letter")) {
                    $file_name = "disbursal_letter.pdf";
                }

                if (strstr("NOC Settlement Letter", "Settlement Letter")) {
                    $file_name = "settlement_letter.pdf";
                }

                if (strstr("NOC Settlement Closing Letter", "Settlement Closing Letter")) {
