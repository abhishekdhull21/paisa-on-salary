...
//        exit;
    ...
    public function getLeadDetails($conditions) {
        ...
        $select .= ' L.loan_status_id, DATE_FORMAT(LD.lead_disbursal_approve_datetime, "%d-%m-%Y %H:%i:%s"), L.loan_disbursement_trans_status_id, C.customer_executive_reloan_flag, C.customer_executive_reloan_remark, C.customer_executive_reloan_user_id, ';
    ...
    public function customerPersonalDetails($conditions = null) {
        $select = 'LD.lead_id, LD.loan_amount, LD.lead_data_source_id, LD.lead_status_id,C.*, CE.*,C.city_id as res_city_id,C.state_id as res_state_id,CE.city_id as office_city_id,CE.state_id as office_state_id';
        $this->db->select($select);
        $this->db->from($this->table . ' LD');
        $this->db->join($this->table_state . ' ST', 'ST.m_state_id = LD.state_id', 'left');
        $this->db->join($this->table_city . ' CT', 'CT.m_city_id = LD.city_id', 'left');
...
//                echo $this->db->last_query();
    ...
    public function getCompanyMaster() {
        return $this->db->select('m_company_id, m_company_name')
                        ->where(['m_company_active' => 1, 'm_company_deleted' => 0])
                        ->from('master_company')
                        ->get()->result();
    }
                                ...
                                <table width="778" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family: Courier, arial;padding:10px; border:solid 1px #ccc; font-family:Arial, Helvetica, sans-serif; font-size:15px;">
                                        ...
                                        <td colspan="3" valign="top"><table width="100%" border="0">
                                                <tr>
                                                    <td valign="top">
                                                        ...
                                                        <p style="line-height:22px;font-family: Courier, arial; margin:0px 0px 10px 0px;">We have received all your details and your submitted loan application has been approved.</p>
                                    ...
                                    <tr>
                                        <td colspan="3" style="font-size:17px;line-height: 25px;padding-bottom: 6px;">
                                            ...
                                            <p style="line-height:22px;font-family: Courier, arial; margin:0px 0px 10px 0px;">Please share your kind acceptance over email to execute further.</p>
...
//    }
    ...
    public function send_Legal_Notice_On_Mailer($lead_id, $customer_email, $customer_name) {
        ...
        $dataArr = ['legal_notice_lead_id' => $lead_id,
            ...
            <table style="width:892px;height:1262px; margin: 0 auto;font-family: Courier, arial;">
                    <tr>
                        <td style="background:#000;"><center>
                            <img style="width:auto;" src="https://www.surya.com/public/image/adv_header.jpg" alt="background image"/>
                            </center>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="text-align:center;"><b style="font-size: 20px;">Legal Notice</b></td>
                        <br><br>
                    </tr>
                    <tr>
                       <td>
                          <span> <b> ' . $customer_name . ',</b></span><br/>
                          <br>Under instructions from and on behalf of my client DEVMUNI LEASING & FINANCE LIMITED With the brand name “Bharat Loan” having its ' . REGISTED_ADDRESS . ', I address you as under. <br><br>
                       </td>
                    </tr>
                    <tr>
        ...
        $return_array = lw_send_email($customer_email, $subject, $pdf_html, "", "", "", "", "", $file_name, "legal_notice.pdf");
