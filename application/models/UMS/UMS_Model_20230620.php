...
class UMS_Model extends CI_Model {
    ...
    public function getMappedCreditHead($user_role_id) {
        ...
        $query = $this->db->query("SELECT user_role_supervisor_role_id FROM user_roles WHERE user_role_id=$user_role_id AND user_role_type_id=3")->row_array();
    ...
    public function getCreditHeadL4List($user_id) {
        $credit_list = array();
        $conditions['UR.user_role_type_id'] = 4;
        $conditions['U.is_Active'] = 1;
        $conditions['U.user_status_id'] = 1;
        $conditions['UR.user_role_active'] = 1;
        $conditions['UR.user_role_level'] = 'L4';
    ...
    public function getMappedCreditHeadL4($user_role_id) {

        $query = $this->db->query("SELECT user_role_supervisor_role_id FROM user_roles WHERE user_role_id=$user_role_id AND user_role_type_id=4 AND user_role_level='L3'")->row_array();
    ...
    public function getMappedRoleLevel($user_role_id) {
        ...
        $query = $this->db->query("SELECT user_role_supervisor_role_id, user_role_level FROM user_roles WHERE user_role_id=$user_role_id AND user_role_type_id=4")->row_array();
