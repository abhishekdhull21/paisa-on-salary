        ...
        if ($res->num_rows() > 0) {
           ...
           $mpdf->Output($file_path_with_name, 'F');
            ...
            if (file_exists($file_path_with_name)) {
                ...
                $return_array = common_send_email("rohit@salaryontime.com", $subject, $message, "", $cc_mail, $from_email, "", $file_path_with_name, $file_name, 'Settlement_letter.pdf');

                $return_array['status'] = 1;
                if($return_array['status'] == 1){
    			$return_array['msg'] = "Settlement Letter Send Successfully";
                }else {
                    $return_array['msg'] = "Settlement Letter Not Send Successfully";
                }
...
//            traceObject($this->db->error());
    ...
    public function sent_loan_closed_noc_letter($lead_id) {
        ...
        if (!empty($to)) {
            ...
            $message = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                            <html xmlns="http://www.w3.org/1999/xhtml">
                                ...
                                <body>
                                    <table width="778" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:10px; border:solid 1px #ccc; font-family:Arial, Helvetica, sans-serif;">
                                        <tr>
                                            <td align="left"><img src="https://salaryontime.in/public/front/images/company_logo.jpeg" style="width:140px;height:85px;" /></td>
                                        </tr>
                                        <tr>
            ...
            $file_name = "Noc_letter_" . $lead_id . "_" . date('Ymd') . ".pdf";

            $file_path_with_name = '/var/www/sot_lms/upload/legal/' . $file_name;
            require_once __DIR__ . '/../../vendor/autoload.php';
