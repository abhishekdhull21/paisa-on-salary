...
class Rejection_Model extends CI_Model {
    ...
    public function send_rejection_mail($lead_id, $lead_data, $to_email) {
        $subject = "Loanwalle.com | Application Status : Rejected";

        $message = '<p>Dear Customer,</p>';
        $message .= '<p>Greetings of the day.</p>';
        $message .= '<p>Thank you for your recent loan application with Loanwalle.</p>';
        ...
        $message .= '<p>Team Loanwalle.com</p>';
        $message .= '<p>(Brand Name for Naman Finlease Private Limited)</p>';
