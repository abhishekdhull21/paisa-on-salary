...
//    }
    ...
    public function get_users_lead_list() {
		...
		$sql .= " LEFT JOIN leads LD ON(LD.lead_screener_assign_user_id>0 AND LD.lead_screener_assign_user_id=U.user_id AND LD.lead_status_id IN(2)) AND `LD`.`lead_is_mobile_verified` = 1 AND LD.first_name IS NOT NULL ";
