...
//        echo "<br/>" . $sql;
    ...
    public function get_not_contactable_lead_list(){
        ...
        $sql="select LD.lead_id,LD.email,LD.mobile,LD.first_name,LD.lead_rejected_user_id,LD.user_type,LD.lead_rejected_assign_counter from leads LD";
        ...
        $sql.="(LD.lead_rejected_assign_counter is NULL OR LD.lead_rejected_assign_counter<=5) and LD.lead_rejected_datetime > (curdate() - INTERVAL 5 day)";
        $tempDetails = $this->db->query($sql);
