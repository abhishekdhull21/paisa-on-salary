...
//    }
    ...
    public function get_lead_new_list() {
       ...
       $sql .= " WHERE LD.lead_status_id=1 AND (LD.lead_screener_assign_user_id IS NULL OR LD.lead_screener_assign_user_id=0) AND LD.first_name IS NOT NULL AND LD.lead_data_source_id NOT IN(21,27) ORDER BY LD.lead_id ASC";
    ...
    public function get_users_lead_list() {
        ...
        $sql  = "SELECT U.user_id, U.name, U.email, U.mobile, SUM(IF(LD.lead_id > 0,1,0)) as total_leads, U.user_status_id, LD.first_name, ";
