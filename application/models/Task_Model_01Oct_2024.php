        ...
        if ($res->num_rows() > 0) {
           ...
           $mpdf->Output($file_path_with_name, 'F');
            ...
            if (file_exists($file_path_with_name)) {
                ...
                $return_array = common_send_email($customer_email, $subject, $message, "", $cc_mail, $from_email, "", $file_path_with_name, $file_name, 'Settlement_letter.pdf');
...
//        }
    ...
    public function getRepaymentReminderSend($message_type=NULL) {
        ...
        // echo '<pre>';
        // print_r($result_repayment_reminder); die;
