...
class Report_Model extends CI_Model {
    ...
    public function BOBCollectionandOutstandingModel($fromDate, $c4c_ref) {
     ...
     public function LeadAssignmentSummaryModel() {
        ...
        $q .= "WHERE U.user_id=UR.user_role_user_id AND LD.first_name IS NOT NULL AND LD.lead_status_id IN(2,3) AND LD.stage IN('S1','S2') AND UR.user_role_type_id=2 AND U.user_is_loanwalle=0 AND U.user_active=1 AND U.user_status_id=1 AND UR.user_role_active=1 GROUP BY U.name ASC ";
