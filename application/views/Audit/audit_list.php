                                                                    ...
                                                                    <table class="table table-striped table-bordered table-hover" id="domainTable"  style="border: 1px solid #dde2eb">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th class="whitespace">
                                                                                    <b>Action
                                                                                    <?php //f(in_array($stage, array("S1", "S4", "S20"))) { ?>
                                                                                ...
                                                                                <?php if (in_array($stage, array("S5", "S6", "S10", "S11", "S12", "S13", "S20", "S21", "S22", "S25")) && (in_array(agent, array("CA", "CR3", "DS1", "DS2")))) { ?>
                                                                                    <th class="whitespace"><b>Sanction Manager</b></th>
                                                                            ...
                                                                            if ($totalcount > 0) {
                                                                                ...
                                                                                foreach ($leadDetails->result() as $row) {
                                                                                    ...
                                                                                    <tr  <?= $row_class ?>>
                                                                                        ...
                                                                                        <?php } ?>
                                                                                        <?php if (!in_array($stage, array("S1")) || agent == 'CA') { ?>
                                                                                            <td class="whitespace"><?= (isset($master_data_source[$row->lead_data_source_id])) ? strval(strtoupper($master_data_source[$row->lead_data_source_id])) : '-' ?></td>
                                                                                        <?php } ?>
                                                                                        <?php if (in_array($stage, array("S14", "S16", 'S30'))) { ?>
