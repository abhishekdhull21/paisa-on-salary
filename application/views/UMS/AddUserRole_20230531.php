                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3"  id="user_role_supervisor_role_id_row">
                                                                        ...
                                                                        <select class="form-control"  name="user_role_supervisor_role_id" id="user_role_supervisor_role_id">
                                                                            ...
                                                                            <?php
                                                                            if (!empty($get_chi)) {
                                                                                foreach ($get_chi as $chi_id => $chi_name) {
                                                                                    ?>
                                                                                    <option  value="<?= $chi_id ?>">
                                                                                        <?= $chi_name ?>
                                                                                    </option> 
                                                                    ...
                                                                    <div class="col-md-3"  id="user_role_supervisor_role_cid_row">
                                                                        <label><span class="span">*</span> Credit Head  </label>
                                                                        <select class="form-control"  name="user_role_supervisor_role_id" id="user_role_supervisor_role_id">
                                                                            <option value="">Select</option>
                                                                            <?php
...
<script>
    $(document).ready(function () {
        $("#user_role_state_id_row, #user_role_branch_id_row, #user_role_scm_id_row, #user_role_supervisor_role_id_row, #user_role_supervisor_role_cid_row").hide();
