                                                                    ...
                                                                    <?php } if (!empty($user_data['user_role_type_id']) && $user_data['user_role_type_id'] == 3) { ?> 
                                                                        <div class="row" id="user_role_supervisor_role_id">
                                                                            <div class="col-md-6" id="div_role_level_id">
                                                                                ...
                                                                                <select class="form-control"  name="user_role_level" id="user_role_level" onchange="show_reporting_list(this)" required>
                                                                                    <option value="" >select</option>
...
<script type="text/javascript">
                                                                                    ...
                                                                                    function show_reporting_list(e) {

                                                                                        var selected_level = e.value;

                                                                                        if (selected_level == "L4" || selected_level == "") {
...
?>
                                                                                            ...
                                                                                            $.ajax(
                                                                                                    {
                                                                                                        url: "<?= base_url('ums/get-reporting-list') ?>",
                                                                                                        method: "post",
                                                                                                        dataType: "json",
                                                                                                        data: {user_id: user_id, level_scope: selected_level, csrf_token},
                                                                                                        success: function (response) {
                                                                                                            var credit_heads = response.data;
...
//                                                                                                            }
                                                                                                            ...
                                                                                                            $("#div_credit_id").html(html);
                                                                                                            $("#div_credit_id").show();
                                                                                                            $("#div_screener").html(html);
                                                                                                            $("#div_screener").show();
                                                                                                        },
                                                                                                        error: function (xhr) {
