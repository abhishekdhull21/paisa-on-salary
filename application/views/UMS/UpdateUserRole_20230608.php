                                                        ...
                                                        <?php if (in_array($user_data["user_status_id"], [1])) { ?>
                                                            <form id="formData" action="<?= base_url($umsActionUrl) ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <?php } if (!empty($user_data['user_role_type_id']) && in_array($user_data['user_role_type_id'], [3])) { ?> 
                                                                    ...
                                                                    <?php } if (!empty($user_data['user_role_type_id']) && in_array($user_data['user_role_type_id'], [2])) { ?>
