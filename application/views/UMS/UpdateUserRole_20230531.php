                                                            ...
                                                            <form id="formData" action="<?= base_url($umsActionUrl) ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <?php } if (!empty($user_data['user_role_type_id']) && in_array($user_data['user_role_type_id'], [2])) { ?> 
                                                                        <div class="row" id="user_role_supervisor_role_id_row">
                                                                            <div class="col-md-6" id="div_scm_id">
                                                                                ...
                                                                                <select class="form-control"  name="user_role_supervisor_role_id" id="user_role_supervisor_role_id">
                                                                                    <option value="">Select</option>
                                                                                    <?php if (!empty($get_chi)) { ?>
                                                                                        <?php foreach ($get_chi as $chi_id => $chi_name) : ?>
                                                                                            <option value="<?= $chi_id ?>" <?php
                                                                                            if ($getMappedSCM['user_role_id'] == $chi_id) {
                                                                                                echo "selected";
                                                                                            }
                                                                                            ?>><?= $chi_name; ?></option>
                                                                                                <?php endforeach; ?>
                                                                        ...
                                                                        <div class="row" id="user_role_supervisor_role_cid_row">
                                                                            <div class="col-md-6" id="div_scm_id">
                                                                                <label><span class="span">*</span>Reporting</label>
                                                                                <select class="form-control"  name="user_role_supervisor_role_id" id="user_role_supervisor_role_id">
                                                                                    <option value="">Select</option>
