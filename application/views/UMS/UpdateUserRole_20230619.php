                                                        ...
                                                        <?php if (in_array($user_data["user_status_id"], [1])) { ?>
                                                            <form id="formData" action="<?= base_url($umsActionUrl) ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <?php } if (!empty($user_data['user_role_type_id']) && $user_data['user_role_type_id'] == 8) { ?>
                                                                    ...
                                                                    <?php } if (!empty($user_data['user_role_type_id']) && in_array($user_data['user_role_type_id'], [7])) { //2, 3,      ?> 
                                                                        <div class="col-md-3">
                                                                    ...
                                                                    <?php } if (!empty($user_data['user_role_type_id']) && $user_data['user_role_type_id'] == 3) { ?> 
                                                                        <div class="row" id="user_role_supervisor_role_id">
                                                                            <div class="col-md-6" id="div_role_level_id">
                                                                                ...
                                                                                <select class="form-control"  name="user_role_level" id="user_role_level">
                                                                                    <option value="L2" selected>L2</option>
                                                                                </select>
                                                                            </div>

                                                                            <div class="col-md-6" id="div_credit_id">
                                                                                <label><span class="span">*</span>Reporting</label>
                                                                                <select class="form-control"  name="user_role_credit_head_id" id="user_role_credit_head_id">
                                                                                    <option value="">Select</option>
                                                                                    <?php
                                                                    ...
                                                                    <?php } if (!empty($user_data['user_role_type_id']) && $user_data['user_role_type_id'] == 2) { ?>
                                                                        ...
                                                                        <div class="row" id="user_role_supervisor_role_id">
                                                                            ...
                                                                            <div class="col-md-6" id="div_credit_id">
                                                                                <label><span class="span">*</span>Reporting</label>
                                                                                <select class="form-control"  name="user_role_credit_id" id="user_role_credit_id">
                                                                                    <option value="">Select</option>
                                                                                    <?php
                                                                                    if (!empty($getCredit)) {
                                                                                        foreach ($getCredit as $value) {
                                                                                            ?>
                                                                                            <option  value="<?= $value['user_role_id'] ?>" <?php
                                                                                            if ($getMappedCredit['user_role_id'] == $value['user_role_id']) {
                                                                                                echo "selected";
                                                                                            }
                                                                                            ?>><?= $value['name'] ?></option> 
                                                                                                     <?php
                                                                    ...
                                                                    <?php } if (!empty($user_data['user_role_type_id']) && $user_data['user_role_type_id'] == 4) { ?>

                                                                        <div class="row" id="user_role_supervisor_role_id">
                                                                            <div class="col-md-6" id="div_role_level_id">
                                                                                <label><span class="span">*</span>User Role Level</label>

                                                                                <select class="form-control"  name="user_role_level" id="user_role_level" onchange="show_credit_head_list(this)">
                                                                            ...
                                                                            <div class="col-md-6" id="div_credit_head">
                                                                                <?php
                                                                                if ($getMappedRoleLevel != "L4") {
                                                                                    ?>
                                                                                    <label><span class="span">*</span>Reporting</label>
                                                                                    <select class="form-control"  name="user_role_credit_head_id" id="user_role_credit_head_id" required>
                                                                                        <option value="0">Select</option>
                                                                                        <?php
                                                                                        if (!empty($getCreditHeadL4)) {
                                                                                            foreach ($getCreditHeadL4 as $value) {
                                                                                                ?>
                                                                                                <option  value="<?= $value['user_role_id'] ?>" <?php
                                                                                                if ($getMappedCreditHeadL4['user_role_id'] == $value['user_role_id']) {
                                                                                                    echo "selected";
                                                                                                }
                                                                                                ?>><?= $value['name'] ?></option> 
                                                                                                         <?php
                                                                    ...
                                                                    <?php } if (!empty($user_data['user_role_type_id']) && in_array($user_data['user_role_type_id'], [13])) { ?> 
...
<script type="text/javascript">
                                                                                    ...
                                                                                    function show_credit_head_list(e) {
                                                                                        var selected_level = e.value;
                                                                                        if (selected_level == "L4") {
                                                                                            $("#div_credit_head").html('');
                                                                                        } else {
<?php
if (!empty($getMappedCreditHeadL4['user_role_id'])) {
    ?>
                                                                                                var get_mapped_credit_head_user_role_id = <?= $getMappedCreditHeadL4['user_role_id'] ?>;
    <?php
}
?>
                                                                                            var user_id = '<?= $enc_user_role_id; ?>';
                                                                                            $.ajax(
                                                                                                    {
                                                                                                        url: "<?= base_url('ums/get-credit-head-roles') ?>",
                                                                                                        method: "post",
                                                                                                        dataType: "json",
                                                                                                        data: {user_id: user_id, csrf_token},
                                                                                                        success: function (response) {
                                                                                                            var credit_heads = response.msg;
                                                                                                            var html = '<label><span class="span">*</span>Reporting</label>' +
                                                                                                                    '<select class="form-control"  name="user_role_credit_head_id" id="user_role_credit_head_id" required>' +
                                                                                                                    '<option value="0">Select</option>';
                                                                                                            for (var i = 0; i < credit_heads.length; i++) {
                                                                                                                if(<?= $this->encrypt->decode($enc_user_role_id)  ?> != credit_heads[i].user_role_id){
<?php
if (!empty($getMappedCreditHeadL4['user_role_id'])) {
    ?>
                                                                                                                    if (get_mapped_credit_head_user_role_id == credit_heads[i].user_role_id) {
                                                                                                                        html += '<option  value="' + credit_heads[i].user_role_id + '" selected>' + credit_heads[i].name + '</option>';
                                                                                                                    } else {
                                                                                                                        html += '<option  value="' + credit_heads[i].user_role_id + '">' + credit_heads[i].name + '</option>';
                                                                                                                    }
    <?php
} else {
    ?>
...
?>
                                                                                                            ...
                                                                                                            html += '</select>';
                                                                                                            $("#div_credit_head").html(html);
                                                                                                            $("#div_credit_head").show();
                                                                                                        },
                                                                                                        error: function (xhr) {
