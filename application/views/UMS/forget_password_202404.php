                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="form">
                        <form method="post" action="<?= base_url('verifyUser'); ?>" id="formData" autocomplete="off">
                            <p class="text-center">
                                <img class="img-rounded" src="<?= LMS_BRAND_LOGO ?>" alt="logo">
                            </p>
                            <p class="text-center mb-4">
                            <div class="titleSignin text-center">FORGOT PASSWORD?</div>
                            </p>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control input" placeholder="type here" title="Email" required>
                            </div>

                            <div class="form-group">
                                <button type="submit" class="form-control" id="userSigin" title="Get OTP">Get OTP</button>
                                <!--<a href="/" style="text-align: center">Back to login</a>-->
                            </div>
                        </form>
