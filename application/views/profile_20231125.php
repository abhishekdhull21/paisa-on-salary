                                            ...
                                            <div class="box-widget widget-module">
                                                ...
                                                <div class="widget-container">
                                                    ...
                                                    <div class=" widget-block">
                                                            ...
                                                            <table class="table dt-table table-striped table-bordered table-responsive table-hover" style="border: 1px solid #dde2eb">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?= inscriptionNumber($userDetails['mobile']); ?></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?= $_SESSION['isUserSession']['user_id']; ?></td>

                                                                    </tr>
                                                                    <?php if ($add_ifsc_flag == 1) { ?>
                                                                        <tr>

                                                                            <th><b>Add IFSC Code</b></th>

                                                                            <td><a href="<?= base_url('addBankDetails'); ?>">Click Here</a></td>
                                                        ...
                                                        <?php if (in_array(agent, ["CR1", "CO1", "CO2", "CO4"])) {
                                                            ?>
                                                            <div class="row">
                                                                    ...
                                                                    <form id="insert_lead_allocation" method="post" enctype="multipart/form-data">
                                                                        ...
                                                                        <?php } elseif (in_array(agent, ["CO1", "CO2", "CO4"])) { ?>
                                                                            ...
                                                                            <?php if (agent == "CO4") { ?>
                                                                                ...
                                                                                <tr>
                                                                                    <th style="text-align: center;"><b>Case Type Categories</b></th>
                                                                                    <td>
                                                                                        <label><input type="radio" name="case_type" value="1" <?= ($allocation_data['uca_user_case_categories'] == 1) ? "checked" : ''; ?> required>&nbsp;&nbsp;A&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                                                        <label><input type="radio" name="case_type" value="2" <?= ($allocation_data['uca_user_case_categories'] == 2) ? "checked" : ''; ?> required>&nbsp;&nbsp;B&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                                                    </td>
                                                                                </tr>
                                                                            <?php } elseif (agent == "CO1") { ?>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <label><input type="radio" name="case_type" value="1" <?= ($allocation_data['uca_user_case_categories'] == 1) ? "checked" : ''; ?> required>&nbsp;&nbsp;A&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                                                        <label><input type="radio" name="case_type" value="2" <?= ($allocation_data['uca_user_case_categories'] == 2) ? "checked" : ''; ?> required>&nbsp;&nbsp;B&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                                                        <label><input type="radio" name="case_type" value="3" <?= ($allocation_data['uca_user_case_categories'] == 3) ? "checked" : ''; ?> required>&nbsp;&nbsp;C</label>
                                                                                    </td>
                                                                                </tr>
