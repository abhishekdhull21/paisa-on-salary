                                                    ...
                                                    <div class=" widget-block">
                                                        <div class="row">
                                                            <form id="Report" action="" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="col-md-2" id="month_wise" style="display: none">
                                                                    <label id="month_wise_label"></label>
                                                                    <select class="form-control" name="month_wise" id="report_id">

                                                                        <option value="">Select</option>
                                                                        <?php
                                                                         $currentDate = date("F - y");
                                                                         for ($i = 3; $i <= 12; $i++) {
                                                                                $months[] = date("F - y", mktime(0, 0, 0, $i, 1, 2023));
                                                                ...
                                                                <div class="col-md-2" id="source_name" style="display: none">
                                                                    ...
                                                                    <select class="form-control" name="source_name" id="report_id">
                                                                        ...
                                                                        <option value="Website BL">Website BL</option>
                                                                        <option value="Import">Import</option>
                                                                        <option value="Refcase">Refcase</option>
                                                                        <option value="FBLeadForm">FBLeadForm</option>
                                                                        <option value="Appsurya">Appsurya</option>
                                                                        <option value="CHATBOT">CHATBOT</option>
                                                                        <option value="APPBLIOS">APPBLIOS</option>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#report_id").change(function () {
            ...
            var showDiv = [4, 6, 11, 13, 14, 29, 9, 22, 23, 24];
            ...
            if (showDiv.indexOf(val) != -1) {
                ...
                if (val == 67){
                    $("#month_wise_label").text("Month Wise")
                    $('#source_name_label').text('Source Name')
                }
              $("#month_year").hide();
                $("#financial_year").hide();
