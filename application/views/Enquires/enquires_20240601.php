                                                                ...
                                                                <table class="table table-hover">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="whitespace"><b>Otp Verify</b></th>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            foreach ($leadDetails as $row) :
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="whitespace"><?= ($row['first_name']) ? $row['first_name'] : '-' ?></td>
                                                                                     <td class="whitespace"><?= ($row['lead_is_mobile_verified']) ? 'OTP Verified' : 'OTP Not Verified' ?></td>
