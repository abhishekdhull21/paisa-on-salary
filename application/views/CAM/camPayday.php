            ...
            <div class="col-md-6">
                <div class="row" style="margin-bottom:10px !important;">
                    ...
                    <div class="col-md-2" style="padding-left: 0px;">
                        <input type="text" class="form-control inputField" id="roi" name="roi" value="1" min="1.00" max="1.00" onchange="calculateAmount()" autocomplete="off" style="width:100% !important;">
                    </div>
