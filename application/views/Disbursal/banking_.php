...
<?php if (in_array(agent, array("CR2", "DS1", "CA", "SA")) && in_array($leadDetails->stage, array("S5", "S6", "S11", "S21", "S22", "S25"))) { ?>
    <div class="footer-support">
        <h2 class="footer-support">
            ...
            <select class="form-control inputField" id="bank_ac_verification" name="bank_ac_verification" autocomplete="off">
                ...
                if (!empty($master_bank_account_status)) {
                    foreach ($master_bank_account_status as $account_status_key => $account_status_name) {
                        ?>
                        <option value="<?= $account_status_key ?>"><?= $account_status_name ?></option>
                        <?php
                    }
                }
                ?>
...
<?php if (false && in_array(agent, array("CR2", "DS1", "CA", "SA")) && in_array($leadDetails->stage, array("S5", "S6", "S11", "S21", "S22", "S25"))) { ?>
    <div class="footer-support">
        <h2 class="footer-support">
