...
<div class="footer-support">
    <h2 class="footer-support">
        <button type="button" class="btn btn-info collapse" data-toggle="collapse" data-target="#FINBOXDEVICE" onclick="getFinBoxDevice('<?= $leadDetails->lead_id ?>')">Fin Box Device &nbsp;<i class="fa fa-angle-double-down"></i></button>
    </h2>
</div>
<div id="FINBOXDEVICE" class="collapse"> 
    <div id="viewFinBoxDevice"></div>
</div>