...
<div class="footer-support">
    <h2 class="footer-support">
        <button type="button" class="btn btn-info collapse" data-toggle="collapse" onclick="checkAACurrentStatus('<?= $this->encrypt->encode($leadDetails->lead_id) ?>')" data-target="#ACCOUNTAGRIGATOR" >BANK STATEMENT & BANKING ANALYSIS &nbsp;<i class="fa fa-angle-double-down"></i></button>
    </h2>
</div>
...
<div id="ACCOUNTAGRIGATOR" class="collapse">
	...
	<table class="table">
		<tbody>
			...
			<tr id="FI_request_form" style="display:none">
				<td colspan="3">
					<div class="row" style="padding: 20px;">
						<div class="col-md-12 col-sm-12"style="padding-bottom: 0px;"><h3>Financial Information request</h3></div>
			...
			<tr id="bankStatementBox" style="display:none">
				<td colspan="3" >
