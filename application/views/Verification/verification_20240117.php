...
<div class="table-responsive">
      <form id="FormSavePAN" class="form-inline" method="post" autocomplete="off">
		...
		<table class="table table-bordered">       
			<tr>                
				...
				<td><input type="text" name="pan_number" autocomplete="off" class="form-control inputField" id="dual_pan_number" placeholder="Enter Your PAN Number." maxlength="12" onmouseout="validatePanNumber()" value="" required="" oninput="this.value = this.value.toUpperCase()"></td>                
				<th><span id="errorpancard"></span></th>
				<th><span id="datapancard"></span></td>            
			</tr>
			<tr>  
                <th></td>  			
				<th><span id="show_hide_id"><button id="btnFormSavePAN" class="btn btn-success lead-pancard-button" onclick="validatePanNumber('yes')">Save</button></span></th>                
				<td><span id="respone_data_number"></span><br><span id="respone_data_name"></span><br><span id="respone_data_father_name"></span></td> 			
			</tr>
        </table>
		</form>
</div>
