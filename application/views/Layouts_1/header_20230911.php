...
if (empty($_SESSION['isUserSession']['user_id'])) {
    ...
    if (!empty($_SESSION['isUserSession']['access_url'])) {
        ...
        $qry = "SELECT mau_role_id, mau_url FROM master_accxess_url WHERE mau_active=1 AND mau_deleted=0 AND mau_role_id=".$_SESSION['isUserSession']['role_id'];
    ...
    if ((in_array($url1, $_SESSION['isUserSession']['access_url'])) || ($_SESSION['isUserSession']['role_id']==1) || ($url1=='home')  || ($url1=='search')  ||  ($url1=='getleadDetails')  ||  ($url2=='edit-blog')  || ($url2=='add-blog')) { 
    }
    else{
