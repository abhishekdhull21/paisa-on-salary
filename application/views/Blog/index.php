                                        ...
                                        <div class="login-formmea">
                                            <div class="box-widget widget-module">
                                                <div class="widget-head clearfix">
                                                    ...
                                                    <form method="POST" class="form-inline" style="margin-top:8px;" action="<?= base_url('blog-list') ?>">
                                                                        ...
                                                                        if (!empty($blogDetails)) {
                                                                            ...
                                                                            foreach ($blogDetails as $blogData) {
                                                                                ...
                                                                                <tr class="table-default" id="id_<?=$i?>">
                                                                                    ...
                                                                                    <td class="whitespace"><img width="100" height="50" src="blog/<?=$blogData["wb_thumb_image_url"]?>"></td>
