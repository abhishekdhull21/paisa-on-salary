                                            ...
                                            <div class="box-widget widget-module">
                                                <div class="widget-head clearfix">
                                                    ...
                                                    <?php } else { ?>
                                                        Add Blog
                                                    <?php } ?>
                                                    :: <a href="<?=base_url('blog-list'); ?>"><b><i title="Back" class="fa fa-arrow-left" aria-hidden="true"></i></b></a>
                                                    </h4>
                                                </div>
                                                        ...
                                                        <form id="formData" method="post" enctype="multipart/form-data" action="<?=base_url($blogActionUrl)?>">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select class="form-control" name="wb_publish_status" id="wb_publish_status_id">
                                                                        <option value="">Select</option>
                                                                        <option value="0"<?= (!empty($blog_data["wb_publish_status"]) && $blog_data["wb_publish_status"] == '0') ? 'selected="selected"' : "" ?>>Draft</option>
                                                                        <option value="1"<?= (!empty($blog_data["wb_publish_status"]) && $blog_data["wb_publish_status"] == '1') ? 'selected="selected"' : "" ?>>Publish</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <label for="wb_short_description_id"><span class="span">*</span> Short Description</label>
                                                                    <textarea class="form-control" name="wb_short_description" id="wb_short_description_id"  required/><?= !empty($blog_data["wb_short_description"]) ? $blog_data["wb_short_description"] : "" ?></textarea>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <label for="wb_long_description_id"><span class="span">*</span> Long Description</label>
                                                                    <textarea class="form-control" name="wb_long_description" id="wb_long_description_id"  required/><?= !empty($blog_data["wb_long_description"]) ? $blog_data["wb_long_description"] : "" ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <img width="100" height="50" src="<?=base_url('blog/'.$blog_data["wb_thumb_image_url"])?>">
                                                                    <?php } ?>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <img width="100" height="50" src="<?=base_url('blog/'.$blog_data["wb_banner_image_url"])?>">
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <a class="button-add btn btn-ifo" href="<?= base_url('blog-list') ?>" role="button">Cancel</a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
...
<script src="<?= base_url(); ?>public/tinymce/js/tinymce/tinymce.min.js" referrerpolicy="origin"></script>
<script type="text/javascript">
tinymce.init({
  selector: '#wb_long_description_id,#wb_short_description_id'
});
</script>
