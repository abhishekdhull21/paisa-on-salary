    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td>
                ...
                </a>&nbsp;<?= ($leadDetails->mobile) ? intval($leadDetails->mobile) : '-' ?>&nbsp;
            ...
            <td>
                <a href="tel:<?= $leadDetails->alternate_mobile ?>">
                    <i class="fa fa-phone"></i>
                </a>&nbsp;<?= ($leadDetails->alternate_mobile) ? intval($leadDetails->alternate_mobile) : '-' ?>&nbsp;
        ...
        <tr>
            ...
            <td><a href="mailto:<?= $leadDetails->email ?>"><i class="fa fa-envelope"></i></a>&nbsp;<?= ($leadDetails->email) ? strval($leadDetails->email) : '-' ?></td>
            <th>Email (Office)</th>
            <td><a href="mailto:<?= $leadDetails->alternate_email ?>"><i class="fa fa-envelope"></i></a>&nbsp;<?= ($leadDetails->alternate_email) ? strval($leadDetails->alternate_email) : '-' ?></td>
        </tr>
        <tr>
            <th>Lead Source</th>
