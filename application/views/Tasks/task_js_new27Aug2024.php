                ...
                <div class="col-md-12">
                    <div class="tab" role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <?php } if (in_array(agent, ["AU", "CR1", "CR2", "CR3", "AC1", "AC2", "CA", "SA", "DS1", "DS2", "CO1", "CO2", "CO3","CO4", "CC"]) || $url == "search") { ?>
                            ...
                            <?php } if (in_array(agent, ["AU", "CR2", "CR3", "AC1", "AC2", "CA", "SA", "DS1", "DS2", "CO1", "CO2", "CO3", "CO4", "CFE1"]) || $url == "search") { ?>
                            ...
                            <?php } if ((in_array($leadDetails->stage, array("S14", "S16")) && agent == 'CR2' && $leadDetails->lead_credit_assign_user_id == user_id) || in_array(agent, ["AU", "AC1", "AC1", "AC2", "CO1", "CO2", "CO3", "CO4", "CFE1", "CA", "SA","CO4","CC"]) || $url == "search") { ?>
                        ...
                        <div class="tab-content tabs">
                            <div role="tabpanel" class="tab-pane fade in active mw-1200" id="LeadSaction">
                                ...
                                <div class="footer-support">
                                    <h2 class="footer-support"><button type="button" class="btn btn-info collapse" data-toggle="collapse" data-target="#old_leads" onclick="viewOldHistory('<?= $this->encrypt->encode($leadDetails->lead_id) ?>')">INTERNAL DEDUPE&nbsp;<i class="fa fa-angle-double-down"></i></button></h2>
                                </div>
                                <div id="old_leads" class="collapse"> 
                                    <div id="oldTaskHistory"></div>
                                </div>
                                
                                 <?php if(agent == 'CR1' || agent == 'CR3') { ?>
                                <div class="footer-support">
                                    <h2 class="footer-support"> <button type="button" class="btn btn-info collapse" data-toggle="collapse" id="docs_history" data-target="#docs_leads" onclick="viewDocsHistory('<?= $this->encrypt->encode($leadDetails->lead_id) ?>')">PENDING DOCUMENT&nbsp;<i class="fa fa-angle-double-down"></i></button></h2>
                                </div>
                                <div id="docs_leads" class="<?= $leadDetails->lead_document_pending_status == 1 ? 'collapse in' : 'collapse' ?>"> 
                                    <div id="DocsTaskHistory">
                                         <?php $this->load->view('Document/required_documents'); ?>
                                ...
                                <div class="footer-support">
                                    <h2 class="footer-support"><button type="button" class="btn btn-info collapse" data-toggle="collapse" data-target="#leadLogs" onclick="leadHistoryLogs('<?= $this->encrypt->encode($leadDetails->lead_id) ?>')">Application Log History&nbsp;<i class="fa fa-angle-double-down"></i></button></h2>
                                </div>
                                    ...
                                    <div id="btndivUploadDocs">
                                        ...
                                        <div class="footer-support">
                                            <h2 class="footer-support" style="margin-top: 0px;">
                                                <button type="button" class="btn btn-info collapse" onclick="getCustomerDocs('<?= $this->encrypt->encode($leadDetails->lead_id) ?>', '<?= $leadDetails->customer_id ?>')" data-toggle="collapse" data-target="#Uploaded-Documents">Uploaded Documents&nbsp;<i class="fa fa-angle-double-down"></i></button>
                                            </h2>
                                        </div>
                                ...
                                <div id="btndivReject1">  
                                    <div calss="row" style="border-top: solid 1px #ddd;text-align: center; padding-top : 20px; padding-bottom: 20px; background: #f3f3f3; overflow: auto;">
                                        <div class="col-md-12 text-center">
                                            ...
                                            <?php } if ((agent == 'DS1' || agent == 'CA') && in_array($leadDetails->lead_status_id,array(2,3,4,5,6,7,8,10,11,12,13,21,22,26,27,28,29,30,35,37,43,44,45,46,47))) {  ?>                            
                                            ...
                                            <?php } if ((agent == 'CR2' && $leadDetails->user_type == 'REPEAT' && !empty($leadDetails->lead_credit_assign_user_id) && $leadDetails->lead_credit_assign_user_id == user_id) && in_array($leadDetails->lead_status_id, array(5, 65)) && ($camDetails->cam_status == 1 && $leadDetails->lead_fi_residence_status_id != 1 && $leadDetails->lead_fi_office_status_id != 1)) { ?>
