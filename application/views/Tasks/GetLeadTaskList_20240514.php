                                                                            ...
                                                                            if ($totalcount > 0) {
                                                                                ...
                                                                                foreach ($leadDetails->result() as $row) {
                                                                                    ...
                                                                                    if ((in_array($stage, array("S1")) && $row->utm_source == "pre-approved-offeremail")) {
                                                                                        ...
                                                                                        $row_class = 'style="background-color:#cefad0 !important"';
                                                                                    }
                                                                                    ...
                                                                                    <tr  <?= $row_class ?>>
                                                                                        ...
                                                                                        <?php if (in_array($stage, array("S14", "S16", 'S30'))) { ?>
                                                                                            ...
                                                                                            <td class="whitespace"><?= ($row->disbursal_date) ? strval(($row->disbursal_date)) : "-" ?></td>
                                                                                        ...
                                                                                        <td class="whitespace"><?= ($row->user_type) ? strval(($row->user_type)) : '-' ?></td>
