...
<form id="insertApplication" class="form-inline" method="post" enctype="multipart/form-data" style="margin: 10px;">
    ...
    <div class="col-md-6">
        ...
        <select class="form-control inputField" id="state0" name="state" onchange="state1(this, 10)" autocomplete="off" required="required">
        </select>
    </div>

    <div class="col-md-6">
        <label class="labelField">City&nbsp;<strong class="required_Fields">*</strong></label>
        <select class="form-control inputField" id="city0" name="city" onchange="city1(this, 10)" autocomplete="off" required="required">
        </select>
    </div>
