...
<div class="table-responsive">
    ...
    <?php if (in_array(agent, ["CO1", "CO2", "CO3", "CR1", "CR2", "CR3"]) && in_array($leadDetails->lead_status_id, [14, 19])) { ?>
...
<div id="Request_Field_Visit" class="collapse"> 
    ...
    <?php if (in_array(agent, ["CO1", "CO2", "CO3", "CFE1"]) && in_array($leadDetails->lead_status_id, [14, 19])) { ?>
        <div class="footer-support">
            <h2 class="footer-support">
    ...
    <div id="AddCollectionVisit" class="collapse"> 
        <form id="FormRequestForCollectionVisit" class="form-inline" method="post" enctype="multipart/form-data" style="margin: 10px;">
            ...
            <?php if (in_array(agent, ['CO1', 'CO2', 'CO3']) && in_array($leadDetails->lead_status_id, [14, 19])) { ?>
