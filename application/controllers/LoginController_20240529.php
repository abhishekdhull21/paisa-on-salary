        ...
        if (true) {
            ...
            switch ($labelname) {
                ...
                case 'CR3': // Credit (Credit Head)
                    $where .= " AND is_active='1' AND (user_labels='CC' OR user_labels='CR1' OR user_labels='CR2' OR user_labels='CR3' OR user_labels='DS1' OR user_labels='DS2' OR user_labels='REJ')";
                    break;
