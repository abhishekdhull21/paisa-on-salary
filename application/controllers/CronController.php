     ...
     public function sentRepaymentReminderOnMail(){
		//die;
        	...
        	if ($return_sms['lead_status_id'] != 14 && $return_sms['lead_status_id'] != 19) {
        		...
        		echo json_encode($return_sms); die;
            }
            ...
            $insertReminderAttention = array(
                ...
                $message = '<!DOCTYPE html>
                                ...
                                <head>
                                    ...
                                    .email-content {
                                      height: 180vh;
                                      background-image: url(\'https://paisaonsalary.in/public/images/head_background_mail.jpg\');
                                        ...
                                        <div class="email-container">
                                            <div class="email-content">
                                                <table class="header" width="100%">
                                                    <tr>
                                                        <td  class="left-top"><img src="https://paisaonsalary.in/public/images/Kasar_background.png" alt="Left Banner"></td>
                                                         <td class="right-top" ></td>
                                                    </tr>';
                                                    if(isset($return_sms['days_until_repayment']) && ($return_sms['days_until_repayment'] < 1)){
                                                    $message .= '<tr>
                                                        <td class="left-banner"><img src="https://paisaonsalary.in/public/images/important-reminer.png" alt="Important Reminder"></td>
                                                        <td class="right-banner"><img src="https://paisaonsalary.in/public/images/LAST-DAY.png" alt="LAST DAY"></td>
                                                    </tr>';
                                                    }else {
                                                       $message .= '<tr>
                                                        <td class="left-banner"><img src="https://paisaonsalary.in/public/images/friend_backend.jpg" alt="Frindly Reminder"></td>
                                                        <td class="right-banner"><img src="https://paisaonsalary.in/public/images/'.$days.'-DAYS.png" alt="'.$days.' DAYS"></td>
                                                    </tr>';
                                                    }
