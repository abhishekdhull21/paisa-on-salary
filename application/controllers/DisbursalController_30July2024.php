...
//
    ...
    public function disbursalHistory()
    {
		...
		$disburse_api_status = array(1=>'Success',2=>'Api Error',3=>'Connection Error',4=>'LW Error');
...
//        }
    ...
    public function downloadDisbursalLetter($enc_lead_id) {
        ...
        if (!empty($enc_lead_id)) {
            ...
            $query = $this->db->query("SELECT lead_id, loan_disbursal_letter FROM loan WHERE loan_disbursal_letter IS NOT NULL AND loan_disbursal_letter !='' AND lead_id=$lead_id");
