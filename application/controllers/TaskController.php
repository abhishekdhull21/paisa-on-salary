...
class TaskController extends CI_Controller {
    ...
    public function index($stage) {
        ...
        if ($this->uri->segment(1) == "collection") {
            ...
            //}
        } else if ($this->uri->segment(1) == 'assigned' && $this->uri->segment(2) == 'pre-collection' && in_array($_SESSION['isUserSession']['labels'], ['CO1'])) {
            unset($conditions["LD.stage"]);
        ...
        } else if ($this->uri->segment(1) == 'assigned' && $this->uri->segment(2) == 'collection' && in_array($_SESSION['isUserSession']['labels'], ['CO1'])) {
            unset($conditions["LD.stage"]);
            unset($conditions["LD.lead_status_id"]);
            $where_in['LD.lead_status_id'] = [14, 19];
            $conditions['LD.lead_collection_executive_assign_user_id'] = $_SESSION['isUserSession']['user_id'];
        ...
        $data["user_list"] = $this->Tasks->getUserList();
...
// TODO: THIS EMAIL TEMPLATE SHOULD BE CHANGED ACCORDING TO YOUR NEEDS
        ...
        if (file_exists($file_path_with_name)) {
            ...
            $return_array = common_send_email($email_to, $subject, $message, "", $cc_mail, $from_email, "", $file_path_with_name, $file_name, 'legal_notice.pdf');
        ...
        if (empty($_SESSION['isUserSession']['user_id'])) {
            ...
            if (!empty($_POST["checkList"])) {
                ...
                foreach ($_POST["checkList"] as $lead_id) {
                    ...
                    //echo '<pre>';print_r($update_lead_data);die;
