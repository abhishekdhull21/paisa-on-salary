...
class LWTestController extends CI_Controller {
    ...
    public function apitesting() {
        ...
        if ($api_type == 1) {
            ...
            $return_array = lw_send_email("rohit@salaryontime.com", "LEGAL NOTICE", $message); //"","tech.team@loanwalle.com"
        } else if ($api_type == 8) {
    ...
    public function test() {
        $lead_id = $_GET['lead_id'];
        $customer_email = 'rohit@salaryontime.com';
        $customer_name = 'Ajay';
    ...
    public function send_pre_approved_mail() {
        ...
        $res = lw_send_email('rohit@salaryontime.com', 'Test', 'Testing');
        print_r($res);
        exit;
    }
    ...
    public function check_mail() {
        ...
        common_send_email('rohit@salaryontime.com', $subject, $message);
        ...
        //   CURLOPT_POSTFIELDS => array('from' => 'bhavish@salaryontime.com','to' => 'chhabrabhavish@gmail.com','text' => 'Test','subject' => 'Testing'),
    ...
    function validate_email() {
        ...
        $domain = 'salaryontime.com'; // Replace with your Mailgun domain

        $url = 'https://api.mailgun.net/v3/salaryontime.com/messages';

        $to = 'rohit@salaryontime.com';
        $from = 'ajay@salaryontime.com';
        $subject = 'Test email';
