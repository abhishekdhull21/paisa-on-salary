...
//            $principle_amount = $data['data']['uta_user_loan_total_principle'] ? $data['data']['uta_user_loan_total_principle'] : 0;
//            $principle_received = $data['data']['uta_user_loan_principle_received'] ? $data['data']['uta_user_loan_principle_received'] : 0;
//            $monthly_target_amount = $data['data']['monthly_target_amount'] ? $data['data']['monthly_target_amount'] : 0;
//            $total_collection_amount = $data['data']['uta_user_loan_total_received'] ? $data['data']['uta_user_loan_total_received'] : 0;
            ...
            if ($type_id == 1) {
                ...
                //$cases_percentage = $data['data']['uta_user_loan_closed_cases'] > 0 ? number_format(($data['data']['uta_user_loan_closed_cases'] / $data['data']['uta_user_loan_total_cases']) * 100, 2) : 0;
//                $amount_percentage = !empty($principle_received) && !empty($principle_amount) ? number_format(($principle_received / $principle_amount) * 100, 2) : 0;
...
//                $monthly_achieve_sanction_cases = $data['data']['monthly_achieve_cases'] ? $data['data']['monthly_achieve_cases'] : 0;
//                $monthly_achieve_sanction_amount = $data['data']['monthly_sanction_achieve_amount'] ? $data['data']['monthly_sanction_achieve_amount'] : 0;
...
//                $monthly_achieve_cases = $data['data']['uta_user_achieve_followups'] ? $data['data']['uta_user_achieve_followups'] : 0;
//                    $monthly_achieve_amount = $data['data']['uta_user_loan_total_received'] ? $data['data']['uta_user_loan_total_received'] : 0;
                $monthly_achieve_amount = $data['data']['monthly_sanction_achieve_amount'] ? $data['data']['monthly_sanction_achieve_amount'] : 0;
//                $cases_percentage = $monthly_achieve_cases > 0 ? number_format(($monthly_achieve_cases / $data['data']['uta_user_target_followups']) * 100, 2) : 0;
...
//                            <script href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" ></script>
            ...
            $message = '<head>
                            ...
                            <style>
                                ...
                                .modal-open .modal .btn-default{float: right;position: absolute;right: -3px;border: none;margin-top: 20px; font-size: 15px;}
