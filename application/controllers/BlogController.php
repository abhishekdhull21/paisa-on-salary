                ...
                if($this->blogModel->getCheckBlogTitle($blog_data["wb_title"])) {
                    ...
                    if(!empty($_FILES['wb_thumb_image_url']['name'])) {
                        ...
                        else 
                        {
                          ...
                          $insert_blog_array["wb_thumb_image_url"] = $data['upload_data_thumb_image']['file_name'];
                        }
                    ...
                    if(!empty($_FILES['wb_banner_image_url']['name'])) {                           
                        ...
                        else 
                        {
                          ...
                          $insert_blog_array["wb_banner_image_url"] = $data['upload_data_banner_image']['file_name'];
                        }
                    }
                    ...
                    if(!empty($blog_id)) {
                        ...
                        return redirect(base_url('blog-list'),'refresh');
                    } else {
