...
class CronCallController extends CI_Controller {
    ...
    public function reminderCallScheduleApi($cron_name, $call_type, $mobile_numbder_array) {
        ...
        //1. Reminder :  462826
        //2. Outstanding :  466186
        //3. Defaulter :  466185

        $campaign_array = array(1 => 462826, 2 => 466186, 3 => 466185);
        $accountSid = "loan4smile1";
        $apiKey = "3ebcd50862a13224a911d077bb6e4e6391060b88ba0ce9a9";
        $apiToken = "7b266838cc2a1f28946928c23a8c5b4125d08b13076add7e";
