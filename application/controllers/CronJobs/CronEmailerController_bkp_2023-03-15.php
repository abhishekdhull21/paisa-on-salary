                    ...
                    $email_data['message'] = '﻿<html>
                                    <head>
                                        ...
                                        <style>
                                            ...
                                            @import url("https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Raleway:wght@500;800&display=swap");
                                            @import url("https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Gloock&display=swap");
                                            body {
                                                width: 100% !important;
                                    ...
                                    <body style="padding: 0; margin: 0;" data-new-gr-c-s-check-loaded="14.993.0">
                                        <table width="600" align="center" cellspacing="0" cellpadding="0" class="100px" style="border: 1px solid #bebaba;
                                               background:url("https://surya.com/public/emailimages/not_contactable/bg_image.jpg"); background-position: center; background-size: cover;
                                               cursor: pointer;">
                                            <tbody>
                                                <tr>
                                                    <td align="center">
                                                        <table style="text-align: center;
                                                               padding-bottom: 15px;
                                                               margin-bottom: 15px;" class="100p" bgcolor="" cellspacing="0"
                                                               border="0" width="600" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td style="line-height: 0; padding-top: 0;">
                                                                        <a href="https://www.surya.com/apply-now" target="_blank">
                                                                            <img src="https://surya.com/public/emailimages/not_contactable/banner.jpg" alt="">
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        ...
                                                        <table style="text-align: center;  margin: 0 0 20px 0;" class="100p" bgcolor=""
                                                               cellspacing="0" border="0" width="600" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center" style="font-size: 23px; font-family: "Raleway", sans-serif; font-weight: 400;">
                                                                        <p style=" text-transform: capitalize; color: #000; padding: 7px 0; margin: 0;
                                                                           margin-bottom: 0; font-size: 33px; border-radius: 10px; font-family: "Gloock", serif !important; border-radius: 10px;">
                                                        ...
                                                        <table style="text-align: center; margin: 0 0 30px 0;" class="100p" bgcolor=""
                                                               cellspacing="0" border="0" width="600" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="center" style="font-size: 23px;">
                                                                        <p style="text-transform: capitalize; color: #016492; padding: 0 0 7px 0;
                                                                           margin: 0; margin-bottom: 0; font-size: 36px; border-radius: 0; font-style: italic;font-weight: 900;">
                                                                            Bharat  <span style=" text-transform: capitalize; color: #016492; padding: 7px 0; margin: 0;
                                                                                          margin-bottom: 0; font-size: 36px; border-radius: 10px; font-weight: 100 !important;">Loan</span>
                                                        ...
                                                        <table style="text-align: center; padding: 0; margin: 0; width: 600px; margin-bottom: 20px; "
                                                               class="100p" bgcolor="" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr style=" ">
                                                                    <td colspan="3" style="background-color: #fff; border-radius: 11px; color: #000; font-size: 13px; font-family: arial;
                                                                        line-height: 18px; text-align: center;">
                                                                        <b style="font-size: 40px; line-height: 45px; font-family: "Gloock", serif !important;">
                                                                            Starting from <span> <img src="https://surya.com/public/emailimages/not_contactable/icon.png" alt="" style="vertical-align: middle;"></span>
                                                                            <span style="font-size: 40px; line-height: 45px; font-family: "Gloock", serif !important;">5000*</span>
                                                                            <br><span> <a href="https://www.surya.com/apply-now"><img src="https://surya.com/public/emailimages/not_contactable/button.PNG" alt="" style="vertical-align: middle;"></a></span>
                                                                        </b>
                                                                    </td>
                                                                </tr>
                                                            <hr>
                                                            ...
                                                            <tr>
                                                                <td colspan="3" style="background-color: #fff; border-radius: 11px; color: #000; font-size: 13px;
                                                                    ...
                                                                    <b><a style="font-size: 14px;
                                                                          ...
                                                                          text-decoration: none;
                                                                          font-family: "Raleway", sans-serif !important;
                                                                          letter-spacing: 1px;">  www.surya.com </a> &nbsp; &#9864; &nbsp;
                                                                        <a style="font-size: 14px;
                                                                           font-weight: 600;
                                                                           color: #000;
                                                                           text-decoration: none;
                                                                           font-family: "Raleway", sans-serif !important;
                                                                           letter-spacing: 1px;">   info@surya.com</a> &nbsp; &#9864;  &nbsp;
                                                                        <a style="font-size: 14px;
                                                                           font-weight: 600;
                                                                           color: #e80068;
                                                                           text-decoration: none;
                                                                           font-family: "Raleway", sans-serif !important;
                                                                           letter-spacing: 1px;">  +91-8282824-644</a> </b>

                                                                </td>
                                                            </tr>

                                                            <tr>
                                                                <td colspan="3" style="background-color: #fff; border-radius: 11px; text-align: center;">
                                                                    <div>
                                                                        <a href="' . ANDROID_STORE_LINK . '" target="_blank" style="text-decoration: none; vertical-align: middle;">
                                                                            <img src="' . ANDROID_STORE_ICON . '" alt="ANDROID_STORE">
                                                                        </a>
                                                                        ...
                                                                        <a href="' . LINKEDIN_LINK . '" target="_blank" style="text-decoration: none; vertical-align: middle;">
                                                                            <img src="../emailer/images/linkedin.png"
                                                                                 alt="LinkedIn">
                                                                        </a>
                                                                        ...
                                                                        <a href="' . APPLE_STORE_LINK . '" target="_blank" style="text-decoration: none; vertical-align: middle;">
                                                                            <img src="' . APPLE_STORE_ICON . '" alt="APPLE_STORE">
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            </tr>
