    ...
    public function voiceBlastReminder5_2Day() {
        ...
        if (true) {
            ...
            if (!empty($tempDetails)) {
                ...
                $email_data = array();
                $email_data['email'] = "alam.ansari@surya.com";
...
//            $this->middlewareEmail($email_data['email'], $email_data['subject'], $email_data['message'], '', 99);
    ...
    public function reminderCallScheduleApi($cron_name, $call_type, $mobile_numbder_array) {
        ...
        $campaign_array = array(1 => 635986, 2 => 635987, 3 => 635988);
        $accountSid = "devmunileasingampfinance1";
        $apiKey = "efc781fadca5a453e145a637f0517996360f9601b74bb73c";
        $apiToken = "4a676bf7adab7c1b4d81191e112d46d509408406ab6ca6ce";
