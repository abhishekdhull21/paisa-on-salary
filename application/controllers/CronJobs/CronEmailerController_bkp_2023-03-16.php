    ...
    class CronEmailerController extends CI_Controller {
        ...
        public function birthdayemailer() {
            ...
            if (!empty($tempDetails)) {
                ...
                $email_data = array();
                $email_data['email'] = "shubham.agrawal@surya.com";
...
//        ini_set("display_errors", 1);
            ...
            if ($time_close > 1155) {
//            $this->middlewareEmail("shubham.agrawal@surya.com", "CRON CALL EMAIL | freshLoan26Jan22NewCustEmailer", "cron was called again | ".date("Y-m-d H:i:s"), '', 99);
                die;
            }
...
//                        $to_email = 'shubham.agrawal@surya.com';
            ...
            if (!empty($tempDetails)) {
                ...
                foreach ($tempDetails as $customer_data) {
                    ...
                    if (!empty($customer_data['email'])) {
                        ...
                        $email_data = array();
                        $to_email = $customer_data['email'];
                        //$to_email = 'akash.kushwaha@surya.com';
                        ...
                        $return_array = $this->middlewareEmail($to_email, $email_subject, $email_message, "", 13, "collection@surya.com", 'meena.joshi@surya.com');
                ...
                foreach ($tempDetails as $customer_data) {
                    ...
                    if (!empty($customer_data['email'])) {
                      ...
                      //  $to_email = 'akash.kushwaha@surya.com';
                        ...
                        $return_array = $this->middlewareEmail($to_email, $email_subject, $email_message, "", 14,  "collection@surya.com", 'meena.joshi@surya.com');
            ...
            if (!empty($tempDetails)) {
                ...
                foreach ($tempDetails as $customer_data) {
                    ...
                    if (!empty($customer_data['email'])) {
                        ...
                        $return_array = $this->middlewareEmail($to_email, $email_subject, $email_message, "", 15,  "collection@surya.com", 'meena.joshi@surya.com');
            ...
            if (!empty($tempDetails)) {
                ...
                foreach ($tempDetails as $customer_data) {
                    ...
                    if (!empty($customer_data['email'])) {
                        ...
                        $return_array = $this->middlewareEmail($to_email, $email_subject, $email_message, "", 16,  "collection@surya.com", 'meena.joshi@surya.com');
            ...
            if (!empty($tempDetails)) {
                ...
                foreach ($tempDetails as $customer_data) {
                    ...
                    if (!empty($customer_data['email'])) {
                        ...
                        $return_array = $this->middlewareEmail($to_email, $email_subject, $email_message, "", 17,  "collection@surya.com", 'meena.joshi@surya.com');
            ...
            if (!empty($tempDetails)) {
                ...
                foreach ($tempDetails as $customer_data) {
                    ...
                    if (!empty($customer_data['email'])) {
                        ...
                        $return_array = $this->middlewareEmail($to_email, $email_subject, $email_message, "", 18,  "collection@surya.com", 'meena.joshi@surya.com');
...
//
        ...
        public function middlewareEmail($email, $subject, $message, $bcc_email = "", $email_type_id = 0, $cc_email = "", $reply_to = "") {
            ...
            if (empty($email) || empty($subject) || empty($message)) {
                ...
                if ($email_type_id == 10) {
                    $from_email = "legal@surya.com";
                    $provider_name = "MAILGUN";
                } else if ($email_type_id == 12) {
                    $from_email = "collection@surya.com";
                    $provider_name = "MAILGUN";
                }
