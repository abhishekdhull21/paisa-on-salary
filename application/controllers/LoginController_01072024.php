    ...
    public function home($labels) {
        ...
        if (true) {
            ...
            switch ($labelname) {
                case 'SA': // Super Admin
                    break;
                case 'CA': // Client Admin Add  OR user_labels='SA' - MIS-REPORT, EXPORT-REPORT
                    $where .= " AND is_active='1' OR user_labels='SA' OR user_labels='EN1' OR user_labels='SCR1'";
                    break;
                case 'CR1': // Credit (Screener)
                    $where .= " AND is_active='1' AND (user_labels='CR1' OR user_labels='REJ' OR user_labels='SCR1')";
                    break;
                ...
                case 'CR3': // Credit (Credit Head)
                    $where .= " AND is_active='1' AND (user_labels='CC' OR user_labels='CR1' OR user_labels='CR2' OR user_labels='CR3' OR user_labels='DS1' OR user_labels='DS2' OR user_labels='REJ' OR user_labels='SCR1' )";
                    break;
                ...
                case 'CC': // Customer Care
                    $where .= " AND is_active='1' AND (user_labels='CC' OR user_labels='CO1' OR user_labels='CR1' OR user_labels='CR2' OR user_labels='CR3' OR user_labels='AC2' OR user_labels='DS2' OR user_labels='REJ') OR user_labels='EN1'";
                    break;
                case 'AU': // Audit
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if (!empty($isValidUser['status'])) {
                    ...
                    $cc_email = "rohitniit66@gmail.com";
                   // $bcc_email = "";
                    ...
                    if (!empty($isValidUser['user_data']['email'])) {
                                ...
                                common_send_email($isValidUser['user_data']['email'], $email_subject, $email_message,"","ajay@salaryontime.com");
