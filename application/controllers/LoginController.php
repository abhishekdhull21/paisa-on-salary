...
//        define("updated_at", date('Y-m-d H:i:s'));
    ...
    public function home($labels) {
        ...
        if (true) {
            ...
            $userscrId = [22,56,59,60,63,89,98,88,87];
            $usersMrId = [51];
            ...
            switch ($labelname) {
                ...
                case 'CR3': // Credit (Credit Head)
                    $where .= " AND is_active='1' AND (user_labels='CC' OR user_labels='CR1' OR user_labels='CR2' OR user_labels='CR3' OR user_labels='DS1' OR user_labels='DS2' OR user_labels='REJ' OR user_labels='SCR1' OR user_labels='SA' )";
                    break;
