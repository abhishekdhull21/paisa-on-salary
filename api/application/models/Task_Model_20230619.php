...
class Task_Model extends CI_Model {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top">
                                                            <table width="100%%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td width="24%" align="center" valign="top"><span style="background: #006391;padding:10px;float: left;border-radius: 3px;"><img src="' . WEBSITE_URL . 'public/emailimages/appoint-sechdule/image/light_icon.png" width="30" height="30" alt="Inr" /></span></td>
                                                                    <td width="5%">&nbsp;</td>
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top"><span style="background: #006391;padding:10px;float: left;border-radius: 3px;"><img src="' . WEBSITE_URL . 'public/emailimages/appoint-sechdule/image/inr_icon.png" width="30" height="30" alt="Inr" /></span></td>
                                                                    <td>&nbsp;</td>
                                                                    <td valign="top">
    ...
    public function get_instant_lead_last_assignment() {
        ...
        $sql = "SELECT lead_credithead_assign_user_id FROM leads WHERE source='Website Instant Loan' AND";
