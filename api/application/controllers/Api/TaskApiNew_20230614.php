...
class TaskApiNew extends REST_Controller {
    ...
    public function viewDocumentFile_post() {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && $header_validation) {
            ...
            return json_encode($this->response(['status' => 1, 'Message' => 'Get image path.', 'doc_data' => $file_path], REST_Controller::HTTP_OK));
        }
    }
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    if ($query->num_rows() > 0) {
                        ...
                        $path = WEBSITE_URL . 'view-document-file/' . $docsId . '/1';
