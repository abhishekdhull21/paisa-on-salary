                ...
                if ($this->form_validation->run() == FALSE) {
                    ...
                    if ($version == $current_version) {
                        ...
                        $upi['payment_method_details'] = array(
                            ...
                            'payment_img_url' => WEBSITE_URL . 'public/image/surya-pay-now.jpeg'
                        );
                        ...
                        $icici_bank['payment_method_details'] = array(
                            ...
                            'payment_img_url' => WEBSITE_URL . 'public/image/surya-icici-icon.png'
                        );
...
//                }
    ...
    public function collexSearchMaster_post() {
