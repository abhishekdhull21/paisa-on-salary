...
// cibil api key
    ...
    define("COLLEX_DOC_URL", 'https://surya.com/direct-document-file/'); //production
    define("LMS_URL", "https://surya.com/");
    define("WEBSITE_URL", "https://www.surya.com/");
...
// *********SOCIAL MEDIA LINK ********
    ...
    define("APPLE_STORE_LINK", WEBSITE_URL . "#");
    define("ANDROID_STORE_LINK", WEBSITE_URL . "#");
    define("LINKEDIN_LINK", WEBSITE_URL . "#");
    define("INSTAGRAM_LINK", WEBSITE_URL . "#");
    define("FACEBOOK_LINK", WEBSITE_URL . "#");
    define("YOUTUBE_LINK", WEBSITE_URL . "#");
    define("TWITTER_LINK", WEBSITE_URL . "#");
