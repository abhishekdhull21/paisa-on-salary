...
$white_list_internal_urls = array("sanction-esign-request", "sanction-esign-response", "aadhaar-veri-request", "aadhaar-veri-response", "sanction-esign-consent");
...
$request_http_referer = isset($_SERVER['HTTP_REFERER']) ? urldecode($_SERVER['HTTP_REFERER']) : '';
//$request_uri = "";
