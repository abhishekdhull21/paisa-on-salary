...
function payday_url_shortener_api($method_name = "", $url = "", $request_array = array()) {
    ...
    if ($method_id == 1) {
        $responseArray = tinyurl_api_call($method_id, $url, $request_array);
    } else {
...
function tinyurl_api_call($method_id, $url = "", $request_array = array()) {
    ...
    $insertApiLog = array();
    $insertApiLog["us_provider_id"] = 2; //SIGNZY
