...
//                }
            ...
            CASE "SIGNZY_API" :
                ...
                if ($api_sub_type == "GET_TOKEN") {
                    ...
                    if ($envSet == "development") {
                        $config_arr['ApiUrl'] = "https://preproduction.signzy.tech/api/v2/patrons/customerid/bankaccountverifications";
                    } else if ($envSet == "production") {
            ...
            CASE "SMS_API" :
                ...
                $config_arr['dlr'] = 1;
                $config_arr['ApiUrl'] = "http://sms6.rmlconnect.net/bulksms/bulksms?";
