...
function routemobile_sms_sent_api_call($sms_type_id, $lead_id = 0, $request_array = array()) {
    ...
    $senderId = array("KASARC", "KASARL", "KASRCL", "KCREDT");
    ...
    try {
        ...
        if ($sms_type_id == 1) {
            ...
            $shortUrl = "https://vap1.in/KCREDT/dBC4Hpx";
            $template_id = "1707172802906192860";
            $headerId = "KCREDT";
            $input_message = "Hi $cust_name, You are just 2 steps away from getting your loan amount disbursed. Plz complete your journey by clicking on $shortUrl Team KASAR";
        }
        ...
        } else if ($headerId == 'KCREDT') {
            $apiData = "username=$sms_username&apikey=3jhWMzQj9tmG&senderid=KCREDT&route=TRANS&mobile=$mobile&text=$message&TID=$template_id&PEID=1701171300552626064&format=json";
        } else {
