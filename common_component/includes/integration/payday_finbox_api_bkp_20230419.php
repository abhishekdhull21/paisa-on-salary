...
function call_finbox_bank_connect_api($method_name = "", $lead_id = 0, $request_array = array()) {
    ...
    if ($method_id == 1) {
        $responseArray = get_finbox_bank_connect_data($method_id, $lead_id, $request_array);
    } else {
        $responseArray["errors"] = "invalid opertation called";
    }
...
function get_finbox_bank_connect_data($method_id, $lead_id = 0, $request_array = array()) {
