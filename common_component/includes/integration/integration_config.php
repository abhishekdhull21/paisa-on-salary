    ...
    switch ($api_type) {
        ...
        CASE "URL_SHORTENER_API" :
            ...
            if ($api_sub_type == "TINYURL") {
                ...
                $config_arr['ApiToken'] = "z0bcjuHx8aLX6cklvRySLA4fomrxcpUFXQ6WGba4wnvp3T6pxWDF2M8TPHWs";
            }
            break;
...
//API Config
        ...
        $apiRequestJsonArray["email"] = "admin@salaryontime.com";
        $apiRequestJsonArray["callbackUrl"] = "https://www.salaryontime.com/";
