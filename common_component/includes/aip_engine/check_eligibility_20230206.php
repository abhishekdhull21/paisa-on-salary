...
//        $data_array['repeat_listed_data'] = $repeat_listed_data;
            ...
            if ($eligibility_status == false) {
                ...
                $update_array = array();
                $update_array['status'] = 'REJECT';
                $update_array['stage'] = 'S9';
                $update_array['lead_status_id'] = $lead_status_id;
                $update_array['updated_on'] = date("Y-m-d H:i:s");
                $update_array['lead_rejected_reason_id'] = 42;
...
//                $email_status = send_eligibility_failed_email($lead_id);
    ...
    function send_eligibility_failed_email($lead_id) {
        ...
        if (empty($email)) {
            ...
            $subject = 'Eligibility Failed - Bharat Loan';
                    ...
                    <html xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <body>
                            <table width="400" border="0" align="center" style="font-family:Arial, Helvetica, sans-serif; border:solid 1px #ddd; padding:10px; background:#f9f9f9;">
                                <tr>
                                    <td width="775" align="center"><img src="https://www.surya.com/public/images/brand_logo.png" style="width:150px;"></td>
                                </tr>
                                <tr>
                                    <td style="text-align:center;"><table width="418" border="0" style="text-align:center; padding:20px; background:#fff;">
                                            <tr>
                                                <td style="font-size:16px;"><img src="https://www.surya.com/public/emailimages/eligibility-failed/eligibility_failed.png" width="305" height="200" alt="thank-you"></td>
                                            </tr>
                                            <tr>
                                                <td style="font-size:16px;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td width="412" style="font-size:16px;"><h2 style="margin:0px; color:#116a97;">Eligibility Failed</h2></td>
                                            </tr>
                                            <tr>
                                                <td><p style="line-height:25px; margin:0px;">you\'re not eligible for the Loan.</p></td>
                                            </tr>
                                        </table></td>
                                </tr>
                                <tr>
