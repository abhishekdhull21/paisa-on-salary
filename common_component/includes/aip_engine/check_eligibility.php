...
function check_customer_eligibility($lead_id) {
    ...
    try {
        ...
        if ($user_type == "NEW" && !empty($monthly_salary_amount) && $monthly_salary_amount >= 25000) {
            $eligibility_remark .= "<br>Monthly Salary - $user_type : " . $monthly_salary_amount . " | Status : Pass";
            $cust_income_flag = 1;
        } else if ($user_type == "NEW" && !empty($monthly_salary_amount) && $monthly_salary_amount < 25000) {
            $eligibility_status = false;
            $eligibility_remark .= "<br>Monthly Salary - $user_type : " . $monthly_salary_amount . " | Status : Fail";
            $cust_income_flag = 2;
        } else if ($user_type == "REPEAT" && !empty($monthly_salary_amount) && $monthly_salary_amount >= 15000) {
            $eligibility_remark .= "<br>Monthly Salary - $user_type : " . $monthly_salary_amount . " | Status : Pass";
            $cust_income_flag = 1;
        } else if ($user_type == "REPEAT" && !empty($monthly_salary_amount) && $monthly_salary_amount < 15000) {
            $eligibility_status = false;
        ...
        if ($eligibility_status == false) {
            ...
            $update_array['lead_rejected_reason_id'] = 30;
