...
class LeadModel extends BaseModel {
    ...
    public function getLeadDetails($lead_id) {
        ...
        if (!empty($lead_id)) {
            ...
            $sql_query = "SELECT LD.lead_id, LD.city_id, LD.state_id, LD.lead_status_id, LD.status, LD.stage, LD.user_type";
...
//            echo $sql;
    ...
    public function getLoanRepaymentDetails($lead_id) {
        ...
        $data = array();
        $sql = "SELECT LD.lead_id, LD.user_type, LD.customer_id, MS.status_name as status, MS.status_stage as stage, LD.lead_status_id, LD.lead_black_list_flag, LD.loan_no, LD.lead_final_disbursed_date, ";
